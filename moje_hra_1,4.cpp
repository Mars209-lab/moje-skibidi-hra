...
int main(){
    ...
    cout << "jake je tvoje oblibene cislo z techto tri? (1, 2, 3) :";
    cin >> ready;
    ...
    if (monstrumtyp == 1){
        ...
        monstrumHP = 10;
        monstrumAT = 5;
        cout << "takovej mensi tank hodne zivotu ale slabsi utok, pro tebe nic tezkeho" << endl;
    }else{
        jmenomonstra = "Drexil";
        monstrumHP = 15;
        monstrumAT = 10;
    ...
    cout << "mno preji hodne stesti :)" << endl;
    ...
    if (akce == "1"){
        ...
        if (classa == "samurai"){
            ...
            cout << "provedl jsi kradez vybaveni a utocic, monstrum tento tah neutoci" << endl;
            cout << "______________________________________________________________________________" << endl;
            monstrumHP -= 3;
            mana -= 3;
            monstrumAT = 0;
