...
int main(){
    ...
    while (potvrzeni !="ano") {
        ...
        if (volba == "samurai"){
            ...
            cout << "hazeci kudla, dvojnasobne poskozeni" << endl;
            ...
            cout << "sneaky peaky utok, utok ze zadu, dvojnasobne poskozeni" << endl;
    ...
    while (hp > 0 && monstrumHP > 0){
        ...
        if (akce == "1"){
            ...
            if (classa == "samurai"){
                cout << "pouzil jsi dark spell na omameni nepritele a utocis" << endl;
                cout << "poskodil jsi nepritele o " << specialniutok2 << " zivotu" << endl;
                monstrumHP -= utok;
                mana -= 4;
                monstrumAT = 0;
            }else if (classa == "rytir"){
                cout << "hazis po nepriteli kudlu" << endl;
                cout << "poskodil jsi nepritele o " << specialniutok2 << " zivotu" << endl;
                monstrumHP -= utok * 2;
                mana -= 4;
            }else if (classa == "kocicka"){
                cout << "tvaris se roztomile a utocis" << endl;
                cout << "poskodil jsi nepritele o " << specialniutok2 << " zivotu" << endl;
                monstrumHP -= 8;
                mana -= 5;
                monstrumAT = 0;
            }else if (classa == "ninja"){
                cout << "preskocis nepritele a utocis ze zadu" << endl;
                cout << "poskodil jsi nepritele o " << specialniutok << " zivotu" << endl;
                monstrumHP -= utok * 2;
                mana -= 5;
            }
